...
class cnnTTLC(nn.Module):
    ...
    # """foo = cnnTTLC(global_avg_pool=True,
    ...
    def __init__(self,
        ...
        Args:
            ...
            loss: a string to indicate whether we want to use the k-means
            friendly or continuous k-means losses
            path_load_M: the PATH to load some pre-trained cluster centers
            num_clusters: number of clusters for k-means friendly training
            num_training_data: store the number of training data to initialise the cluster labels
            lambda_kmeans: trade-off parameter for the k-means loss function
        """
